        ...
        <div class="row justify-content-center">
            <div class="col">
                ...
                <form method="POST" action="">
                    ...
                    <input type="text" id="title" name="title" class="form-control mb-1" value="{{$post->title}}">
                    ...
                    <input type="submit" class="form-control btn btn-primary mt-1" name="add" value="Update">
                </form>
            </div>
        </div>
    </div>
